...
public class TabhostConsumeActivity extends Activity implements
	...
	private Handler handler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			...
			switch (msg.what) {
			case 0:
				ToastUtils.showToast(TabhostConsumeActivity.this, "获取数据失败！",
						2000);
				break;
			// 成功
			case 1:
				if(msg.arg1==AutoListView.LOAD){
					...
					Toast.makeText(TabhostConsumeActivity.this, R.string.error, 2000).show();
				}
				break;
			default:
				break;
	...
	public void onRefresh() {
		getData(CommonData.TIME_ALL, "1",
				CommonData.pageSize + "", AutoListView.REFRESH);
	}
	...
	private void getData(final String time, final String nextpage,
		...
		ExtractorThread.getInstance().getMainHandler().post(new Runnable() {
			...
			public void run() {
				...
				SharedPreferences sharedPreferences = TabhostConsumeActivity.this
