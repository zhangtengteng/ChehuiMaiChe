...
public class ToastUtils
{
    ...
    {
        android.widget.Toast.makeText(mContext, resid, android.widget.Toast.LENGTH_LONG).show();
    }

    public static void showShortToast(Context mContext, int resid)
    {
        android.widget.Toast.makeText(mContext, resid, android.widget.Toast.LENGTH_SHORT).show();
    }
