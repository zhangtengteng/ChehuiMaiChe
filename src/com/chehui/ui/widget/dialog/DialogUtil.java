...
public class DialogUtil
{
     ...
     * @return
     */
    public static AlertDialog activityDialog(Context context, String msg, int posRes, int negRes,
            boolean cancelable, boolean cancelOnOutTouch, final DialogCallback callback)
    {
        if (null == context)
        {
            return null;
