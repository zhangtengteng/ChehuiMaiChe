package com.chehui.ui.widget.dialog;
...
import com.chehui.utils.DisplayUtils;
...
public class AlertDialogBase
{
    ...
    protected void initView(int layoutRes)
    {
        ...
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(layoutWidth,
     ...
     * @param listener
     */
    public void setNegativeButton(int textRes, final View.OnClickListener listener)
    {
        addDialogButton(textRes, R.drawable.selector_dialog_btn_cancel, listener);
    }
    
    public void addDialogButton(int textRes, int btnBg, final View.OnClickListener listener)
    {
